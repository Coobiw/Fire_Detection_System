...
for index,image_name in enumerate(imgnames):
    ...
    # print(image)
    result = predict.YOLO_test(model,image)
...
plt.legend()
plt.title(r'accurate rate analysis of testing set 0.5', fontsize=20)
plt.savefig(r'D:\qbw2\machine_learning\fire_detection\acc_analysis0.5.jpg')
plt.show()
